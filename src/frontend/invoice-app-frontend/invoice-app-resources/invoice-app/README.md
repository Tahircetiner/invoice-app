...
![Design preview for the Invoice app coding challenge](invoice-app-resources/invoice-app/preview.jpg)
...
We strongly recommend overwriting this `README.md` with a custom one. We've provided a template inside the [`README-template.md`](invoice-app-resources/invoice-app/README-template.md) file in this starter code.
